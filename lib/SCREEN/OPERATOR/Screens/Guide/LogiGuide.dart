...
class LogiOperatorGuide extends StatefulWidget {
  const LogiOperatorGuide({super.key});

  @override
  State<LogiOperatorGuide> createState() => _LogiOperatorGuideState();
}

class _LogiOperatorGuideState extends State<LogiOperatorGuide> {
